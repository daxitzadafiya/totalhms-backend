...
class FinishedTaskMail extends Mailable
{
    ...
    {
        $subject = '[NOTICE] Finished task';
        return $this->from($this->from_address, $this->from_name)->view('emails.finishedtask')->subject($subject);
    }
}
