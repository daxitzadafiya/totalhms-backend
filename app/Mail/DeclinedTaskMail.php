...
class DeclinedTaskMail extends Mailable
{
    ...
    {
        $subject = '[HSE][NOTICE] Task is declined';
        return $this->from($this->from_address, $this->from_name)->view('emails.declinedtask')->subject($subject);
    }
}
