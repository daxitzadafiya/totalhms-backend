 ...
 */
class AttendeeProcessing extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'attendee_processing';
    /**
     ...
     */
    protected $fillable = [
        'company_id', 'added_by', 'attendee_id', 'comment', 'attachment_id', 'status', 'responsible_id',
        'responsible_comment', 'responsible_attachment_id'
    ];

    public static $rules = array(
        'company_id'=>'numeric|exists:companies,id',
        'added_by'=>'numeric|exists:users,id',
        'attendee_id'=>'numeric|exists:attendee,id',
    );

    public static $updateRules = array(
        'company_id'=>'numeric|exists:companies,id|sometimes',
        'added_by'=>'numeric|exists:users,id|sometimes',
        'attendee_id'=>'numeric|exists:attendee,id|sometimes',
    );
    /**
     * @OA\Property()
     * @var int
