...
class InviteCustomerService extends Notification
{
    use Queueable;
    public $url;
     ...
     * @return void
     */
    public function __construct($emailContent,$emailDecriptions,$url)
    {
    ...
    public function toMail($notifiable)
    {
        return ( new MailMessage )
            ...
            ->action('Accepte Invite Customer Service', $this->url)
            ->line('Thanks!');
    }
