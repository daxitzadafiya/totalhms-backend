...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor mb-0 mt-0">Activities</h3>
        <ol class="breadcrumb">
                    ...
                    <div class="row pt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ (old('name') != '' ) ? old('name') : (isset($aData->des) ? $aData->des : '') }}" required class="form-control name">
                                <small class="invalid-feedback name"> Name is required </small>
                                <input type="hidden" name="id" id="id" value="{{ isset($aData->id) ? $aData->id : 0}}" />
                            </div>
                        </div>
                    </div>
                </div>
