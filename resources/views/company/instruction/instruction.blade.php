...
<script src="{{ asset('/filejs/company/instruction/instructions.js') }}"></script>
...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor mb-0 mt-0">Instruks</h3>
    </div>
        ...
        <ul class="nav  customtab" role="tablist">
            ...
            <li class="">
                <a class="nav-link   active  " data-toggle="tab" href="#tab4" role="tab">
                    ...
                    <span class="hidden-xs-down">Instruks</span>
                </a>
            </li>
            ...
            <li class="">
                <a class="nav-link   " data-toggle="tab" href="#tab7" role="tab">
                    <span class="hidden-sm-up"> <i class="ti-home"></i></span>
                    <span class="hidden-xs-down">Aktivitet</span>
                </a>
            </li>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="category" id="icatid" required class="form-control">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Søk i instrukser</label>
                                    <input type="text" class="form-control" name="srch" id="inssrch">
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <table id="category" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="#" data-toggle="tooltip" data-id="{{ $data->id }}" data-name="{{ $data->des }}" data-original-title="Rediger" class="edit  editProduct">
                                        {{ ucfirst($data->des) }}</a></td>
                                    <td> @php
                                        if($data->id){
            ...
            <div class="card-body">
                    <table id="template" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="/template/instruk/{{ $data->id }}" class="waves-effect waves-light ">{{ ucfirst($data->title) }}</a></td>
                                <td>
                                    @php
                                    if($data->category_id){
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                                <div class="form-group">
                                        ...
                                        @endphp
                                        @if($cat)
                                        <select name="category" id="acatid" required class="form-control">
                                            <option selected value=''>Alle</option>
                        ...
                        <div class="col-md-2">
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="srch" id="acsrch">
                                    </div>
                        </div>
                        <div class="col-md-4">
                        </div>
                    ...
                    <table id="activities" class="table">
                        ...
                        <tbody>
                            ...
                            @foreach($aData as $data)
                                <tr>
                                    <td>
                                    <a href="/edit/activity/{{ $data->id }}" data-toggle="tooltip"
                                    data-original-title="Rediger" class="edit  editProduct">{{ ucfirst($data->des) }}</a>
                                    </td>
