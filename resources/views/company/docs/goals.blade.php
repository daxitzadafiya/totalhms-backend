...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Legg til HMS-mål for foretaket</li>
        </ol>
    </div>
                ...
                var HightlightButton = function(context) {
                    ...
                    var button = ui.buttonGroup([
                        ui.button({
                            ...
                            contents: '<span class="fa fa-smile-o">Select Custome Template</span> <span class="caret"></span>',
                        ...
                        ui.dropdown({
                            ...
                            contents: "<ol><a href='#'><li>hello</li></a><li>hello europe</li><li>hello europe</li></ol>",
                    ...
                    $(".click2edit").summernote({
                        height: 300,
                        toolbar: [
                            ['style', ['highlight', 'bold', 'italic', 'underline']],
