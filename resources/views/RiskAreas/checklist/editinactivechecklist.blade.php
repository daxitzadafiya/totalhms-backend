...
<script src="{{ asset('/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/sweetalert/sweetalert.min.js') }}"></script>
<script src="{{ asset('/filejs/riskareas/checklist/editinactivechecklist.js') }}"></script>
        ...
        <div class="card card-outline-info">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <button type="button" class="btn btn-warning waves-effect waves-light change_type" data-id="{{ $chkdata->id }}">Add to Active Checklist</button>
