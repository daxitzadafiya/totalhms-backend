...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor mb-0 mt-0">User List</h3>
        <ol class="breadcrumb">
    ...
    <div class="col-md-6 col-4 align-self-center">
       {{--<button class="right-side-toggle waves-effect waves-light btn-info btn-circle btn-sm float-right ml-2"><i class="ti-settings text-white"></i></button>
        --}}
        <a href="{{ url('/admin/add/user')}}"  class="btn float-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i> Add User</a>
