...
<script src="{{ asset('/filejs/document/documentupload.js') }}"></script>
<script>
     $(".s").summernote({
        height: 200,
        toolbar: [
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="POST" enctype="multipart/form-data" action="{{ url('/document/save') }}">
                    <div class="form-body">
                        <div class="row ">
                            <!--/span-->
                            <div class="col-md-6">
                        ...
                        {{ csrf_field() }}
                        @if($url == "create" || isset($tData))
                        <input type="hidden" name="doc_type" value="1" />
                        <input type="hidden" name="template_id" value="{{ isset($rData->template_id) ? ($rData->template_id != 0 ) ? $rData->template_id : '' : isset($tData->id) ? $tData->id : ''}}" id="template_id" />
                    ...
                    <div class="row" id="doc">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" id="input-file-now-custom-3" name="doc" class="dropify" data-height="200" />
                            </div>
                        </div>
                    </div>
                    @endif
