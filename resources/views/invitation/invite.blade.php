...
<div class="text-center">
    ...
    @endif
<form method="POST" action="{{ route('invitation.accepet') }}" class="w-25 mx-auto shadow-lg p-4 mb-5 bg-body rounded" id="invitation-form">
    @csrf
    <input type="hidden" name="token" value="{{ $token }}">
    <input type="hidden" name="email" value="{{ $email }}">

    <div  id="emailHelp" class="form-text fs-5 text-center mb-4">Invitation</div>
    <div class="mb-3">
